...
const ContinuousModeBackupPolicy = {
    ...
    type: {
        ...
        uberParent: "BackupPolicy",
        polymorphicDiscriminator: BackupPolicy.type.polymorphicDiscriminator,
        modelProperties: Object.assign({}, BackupPolicy.type.modelProperties)
    }
};
...
class DatabaseAccountsImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listUsagesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listUsagesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMetricDefinitionsPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_5, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class DatabaseImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, databaseRid, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, databaseRid, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listUsagesPagingAll(resourceGroupName, accountName, databaseRid, options) {
        return tslib.__asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listUsagesPagingPage(resourceGroupName, accountName, databaseRid, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMetricDefinitionsPagingAll(resourceGroupName, accountName, databaseRid, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, accountName, databaseRid, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class CollectionImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listUsagesPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, options) {
        return tslib.__asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listUsagesPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMetricDefinitionsPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class CollectionRegionImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, region, databaseRid, collectionRid, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, region, databaseRid, collectionRid, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class DatabaseAccountRegionImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, region, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, region, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class PercentileSourceTargetImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class PercentileTargetImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, targetRegion, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, targetRegion, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class PartitionKeyRangeIdImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, partitionKeyRangeId, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, partitionKeyRangeId, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class PartitionKeyRangeIdRegionImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, region, databaseRid, collectionRid, partitionKeyRangeId, filter, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, region, databaseRid, collectionRid, partitionKeyRangeId, filter, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class SqlResourcesImpl {
    ...
    listSqlDatabasesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlDatabasesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlDatabasesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlContainersPagingAll(resourceGroupName, accountName, databaseName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlContainersPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlContainersPagingPage(resourceGroupName, accountName, databaseName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listClientEncryptionKeysPagingAll(resourceGroupName, accountName, databaseName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listClientEncryptionKeysPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listClientEncryptionKeysPagingPage(resourceGroupName, accountName, databaseName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlStoredProceduresPagingAll(resourceGroupName, accountName, databaseName, containerName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlStoredProceduresPagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlStoredProceduresPagingPage(resourceGroupName, accountName, databaseName, containerName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlUserDefinedFunctionsPagingAll(resourceGroupName, accountName, databaseName, containerName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlUserDefinedFunctionsPagingAll_1() {
            var e_5, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlUserDefinedFunctionsPagingPage(resourceGroupName, accountName, databaseName, containerName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlTriggersPagingAll(resourceGroupName, accountName, databaseName, containerName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlTriggersPagingAll_1() {
            var e_6, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlTriggersPagingPage(resourceGroupName, accountName, databaseName, containerName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlRoleDefinitionsPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlRoleDefinitionsPagingAll_1() {
            var e_7, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlRoleDefinitionsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listSqlRoleAssignmentsPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listSqlRoleAssignmentsPagingAll_1() {
            var e_8, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listSqlRoleAssignmentsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class MongoDBResourcesImpl {
    ...
    listMongoDBDatabasesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMongoDBDatabasesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMongoDBDatabasesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMongoDBCollectionsPagingAll(resourceGroupName, accountName, databaseName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMongoDBCollectionsPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMongoDBCollectionsPagingPage(resourceGroupName, accountName, databaseName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMongoRoleDefinitionsPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMongoRoleDefinitionsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMongoRoleDefinitionsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listMongoUserDefinitionsPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listMongoUserDefinitionsPagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listMongoUserDefinitionsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class TableResourcesImpl {
    ...
    listTablesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listTablesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listTablesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class CassandraResourcesImpl {
    ...
    listCassandraKeyspacesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listCassandraKeyspacesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listCassandraKeyspacesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listCassandraTablesPagingAll(resourceGroupName, accountName, keyspaceName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listCassandraTablesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listCassandraTablesPagingPage(resourceGroupName, accountName, keyspaceName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class GremlinResourcesImpl {
    ...
    listGremlinDatabasesPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listGremlinDatabasesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listGremlinDatabasesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    listGremlinGraphsPagingAll(resourceGroupName, accountName, databaseName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listGremlinGraphsPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listGremlinGraphsPagingPage(resourceGroupName, accountName, databaseName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class NotebookWorkspacesImpl {
    ...
    listByDatabaseAccountPagingAll(resourceGroupName, accountName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listByDatabaseAccountPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listByDatabaseAccountPagingPage(resourceGroupName, accountName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
...
class RestorableSqlDatabasesImpl {
    ...
    listPagingAll(location, instanceId, options) {
        return tslib.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listPagingPage(location, instanceId, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
