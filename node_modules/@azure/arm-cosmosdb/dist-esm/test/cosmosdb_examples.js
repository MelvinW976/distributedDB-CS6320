...
describe("Cosmosdb test", () => {
    ...
    it("databaseAccounts create test", function () {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    it("databaseAccounts get test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield client.databaseAccounts.get(resourceGroupName, accountName);
            assert.equal(res.name, accountName);
        });
    });
    it("databaseAccounts list test", function () {
        var e_1, _a;
        return __awaiter(this, void 0, void 0, function* () {
            const resArray = new Array();
            try {
                for (var _b = __asyncValues(client.databaseAccounts.listByResourceGroup(resourceGroupName)), _c; _c = yield _b.next(), !_c.done;) {
                    let item = _c.value;
                    resArray.push(item);
                }
            }
    ...
    it("databaseAccounts delete test", function () {
        var e_2, _a;
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=cosmosdb_examples.js.map