...
export class CassandraResourcesImpl {
    ...
    listCassandraKeyspacesPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listCassandraKeyspacesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listCassandraKeyspacesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listCassandraTablesPagingAll(resourceGroupName, accountName, keyspaceName, options) {
        return __asyncGenerator(this, arguments, function* listCassandraTablesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listCassandraTablesPagingPage(resourceGroupName, accountName, keyspaceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
