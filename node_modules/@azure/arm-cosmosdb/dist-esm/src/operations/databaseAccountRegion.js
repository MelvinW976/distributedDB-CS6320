...
export class DatabaseAccountRegionImpl {
    /**
    ...
    listMetricsPagingPage(resourceGroupName, accountName, region, filter, options, _settings) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingPage_1() {
            let result;
            result = yield __await(this._listMetrics(resourceGroupName, accountName, region, filter, options));
    ...
    listMetricsPagingAll(resourceGroupName, accountName, region, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, region, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    _listMetrics(resourceGroupName, accountName, region, filter, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, region, filter, options }, listMetricsOperationSpec);
    }
}
...
//# sourceMappingURL=databaseAccountRegion.js.map