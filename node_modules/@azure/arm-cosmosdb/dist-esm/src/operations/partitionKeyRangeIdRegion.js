...
export class PartitionKeyRangeIdRegionImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, region, databaseRid, collectionRid, partitionKeyRangeId, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, region, databaseRid, collectionRid, partitionKeyRangeId, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=partitionKeyRangeIdRegion.js.map