...
export class CassandraDataCentersImpl {
    /**
    ...
    get(resourceGroupName, clusterName, dataCenterName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, clusterName, dataCenterName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=cassandraDataCenters.js.map