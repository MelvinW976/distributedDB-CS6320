...
export class PercentileSourceTargetImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, sourceRegion, targetRegion, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=percentileSourceTarget.js.map