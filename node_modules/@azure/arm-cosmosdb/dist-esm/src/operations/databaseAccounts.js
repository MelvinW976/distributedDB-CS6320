...
export class DatabaseAccountsImpl {
    ...
    listMetricsPagingAll(resourceGroupName, accountName, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    listUsagesPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = __asyncValues(this.listUsagesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    listMetricDefinitionsPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_5, _a;
            try {
                for (var _b = __asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, accountName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
