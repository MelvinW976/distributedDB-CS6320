...
export class CollectionImpl {
    ...
    listMetricsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, filter, options, _settings) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingPage_1() {
            let result;
            result = yield __await(this._listMetrics(resourceGroupName, accountName, databaseRid, collectionRid, filter, options));
    ...
    listMetricsPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, filter, options) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listMetricsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listUsagesPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options, _settings) {
        return __asyncGenerator(this, arguments, function* listUsagesPagingPage_1() {
            let result;
            result = yield __await(this._listUsages(resourceGroupName, accountName, databaseRid, collectionRid, options));
            yield yield __await(result.value || []);
        });
    }
    listUsagesPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, options) {
        return __asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listUsagesPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    listMetricDefinitionsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options, _settings) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingPage_1() {
            let result;
            result = yield __await(this._listMetricDefinitions(resourceGroupName, accountName, databaseRid, collectionRid, options));
            yield yield __await(result.value || []);
        });
    }
    listMetricDefinitionsPagingAll(resourceGroupName, accountName, databaseRid, collectionRid, options) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listMetricDefinitionsPagingPage(resourceGroupName, accountName, databaseRid, collectionRid, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
