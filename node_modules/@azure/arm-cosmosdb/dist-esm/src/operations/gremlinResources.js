...
export class GremlinResourcesImpl {
    ...
    listGremlinDatabasesPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listGremlinDatabasesPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listGremlinDatabasesPagingPage(resourceGroupName, accountName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listGremlinGraphsPagingAll(resourceGroupName, accountName, databaseName, options) {
        return __asyncGenerator(this, arguments, function* listGremlinGraphsPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listGremlinGraphsPagingPage(resourceGroupName, accountName, databaseName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
