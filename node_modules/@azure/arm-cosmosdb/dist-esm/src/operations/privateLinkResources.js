...
export class PrivateLinkResourcesImpl {
    ...
    listByDatabaseAccountPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listByDatabaseAccountPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByDatabaseAccountPagingPage(resourceGroupName, accountName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, accountName, groupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, groupName, options }, getOperationSpec);
    }
}
