...
function cosmosDbRestorableGremlinResourceList() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.restorableGremlinResources.list(location, instanceId, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=restorableGremlinResourcesListSample.js.map