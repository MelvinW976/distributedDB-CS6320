...
function approveOrRejectAPrivateEndpointConnectionWithAGivenName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginCreateOrUpdateAndWait(resourceGroupName, accountName, privateEndpointConnectionName, parameters);
        console.log(result);
    });
}
function main() {
